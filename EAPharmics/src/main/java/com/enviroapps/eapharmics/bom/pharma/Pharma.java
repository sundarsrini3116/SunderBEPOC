...
public class Pharma extends AbstractPersistableObject {
	 ...
	 * 
	 * @see
	 * com.psc.das.persistence.AbstractPersistableObject#loadPK(java.lang.Object
	 * [])
	 */
	public void loadPK(Object[] pks) {
		this.batch_no = (Long) pks[0];
	...
	/**
	 * @param annual_stability_batch
	 *            the annual_stability_batch to set
	 */
	...
	/**
	 * @param validity_batch
	 *            the validity_batch to set
	 */
	...
	/**
	 * @param initial_analysis_yes
	 *            the initial_analysis_yes to set
	 */
	...
	/**
	 * @param initial_analysis_no
	 *            the initial_analysis_no to set
	 */
	...
	/**
	 * @param itemcode_closure
	 *            the itemcode_closure to set
	 */
	...
	/**
	 * @param itemcode_cotton
	 *            the itemcode_cotton to set
	 */
	...
	/**
	 * @param dessiccantsdesc
	 *            the dessiccantsdesc to set
	 */
	...
	/**
	 * @param itemcode_desiccant
	 *            the itemcode_desiccant to set
	 */
	...
	/**
	 * @param submittedbydate
	 *            the submittedbydate to set
	 */
