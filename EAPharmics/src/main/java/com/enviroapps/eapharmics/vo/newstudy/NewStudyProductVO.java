...
public class NewStudyProductVO {
   ...
   private NewStudyConditionVO studyCondition;
   ...
   private Boolean isLevel1Approval;
   private Boolean isLevel2Approval;
	/**
	...
	/**
	 * @param productId the studyId to set
	 */
   ...
   public void setProprietaryStudyId(String proprietaryStudyId){
	...
	/**
	 * @param desicantCode the desicantCode to set
	 */
	 ...
	 * @param desicantCode the desicantCode to set
	 */
	public void setDesiccantCode(String desicantCode) {
		this.desicantCode = desicantCode;
	}
	...
	/**
	 * @param gallerySettingsCodeId the gallerySettingsCodeId to set
	 */
   ...
   public NewStudyConditionVO getStudyCondition()
   {
      return studyCondition;
   }
  
    
   public void setStudyCondition(NewStudyConditionVO studyCondition)
   {
...
/**
 * @return the isLevel2Approval
 */
public Boolean getIsLevel2Approval() {
	return isLevel2Approval;
}
/**
 * @param isLevel2Approval the isLevel2Approval to set
 */
public void setIsLevel2Approval(Boolean isLevel2Approval) {
	this.isLevel2Approval = isLevel2Approval;
}
}
