...
public class LabelPrintRequestVO {
	...
	private List<LabelPrintRequestDetailVO> details = new ArrayList<LabelPrintRequestDetailVO>();
	 ...
	 * @return the details
	 */
	public List<LabelPrintRequestDetailVO> getDetails() {
		return details;
	}
	/**
	 * @param details the details to set
	 */
	public void setDetails(List<LabelPrintRequestDetailVO> details) {
